...
export default function BudgetSummary({ total, maxItems }) {
    return (
        <div data-budget-summary className="rounded-2xl border border-emerald-200 bg-white p-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
